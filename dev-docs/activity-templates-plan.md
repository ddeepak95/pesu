...
- **UI** — **My Templates** (`/teacher/templates`) and **Class Templates**
  ...
  (`/teacher/templates/:id`) with Clone. **Class settings → Activity Types** section. A **My Templates**
