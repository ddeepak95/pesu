...
/**
 * Select all assignment columns. Using '*' ensures new columns are never
 * silently dropped when the schema evolves. TypeScript type safety is
 * enforced by the `as Assignment` cast at each call site.
 */
