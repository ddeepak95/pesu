...
/**
 * Edit a class-owned activity template, from the super-admin surface. Only
 * active `owner_scope='class'` rows belonging to this class are editable
 * here (RLS also enforces the write); any other id 404s.
 */
export default async function PlatformEditClassTemplatePage({
  params,
}: {
