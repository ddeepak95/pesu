...
/**
 * Edit an institution-owned activity template, from the super-admin surface.
 * Only active `owner_scope='institution'` rows belonging to this institution
 * are editable here (RLS also enforces the write); any other id 404s.
 */
export default async function PlatformEditInstitutionTemplatePage({
  params,
}: {
